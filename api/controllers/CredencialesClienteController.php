<?php
require_once '../db.php';
require_once '../models/CredencialesCliente.php';

use ProyectoTC\Models\CredencialCliente;

class CredencialesClienteController {
    private $credencialesModel;

    public function __construct($pdo) {
        $this->credencialesModel = new CredencialCliente($pdo);
    }
